        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, alice10.animate(aliceTumbling1, aliceTiming1)];
                case 1:
                    _a.sent();
                    console.log("Alice 1 animation complete");
                    return [4 /*yield*/, alice20.animate(aliceTumbling1, aliceTiming1)];
                case 2:
                    _a.sent();
                    console.log("Alice 2 animation complete");
                    return [4 /*yield*/, alice30.animate(aliceTumbling1, aliceTiming1)];
                case 3:
                    _a.sent();
                ...
                case 6:
                    error_1 = _a.sent();
                    alert("Error during animation: ".concat(error_1));
                    return [3 /*break*/, 7];
